...
const setupNet = async (device, safetensor) => {
    ...
    const buf_1 = createWeightBuf(device, 3456, getTensorBuffer(safetensor, metadata['_conv_stem']));
    const buf_2 = createWeightBuf(device, 128, getTensorBuffer(safetensor, metadata['_bn0.running_mean']));
    const buf_3 = createWeightBuf(device, 128, getTensorBuffer(safetensor, metadata['_bn0.weight']));
    const buf_4 = createWeightBuf(device, 128, getTensorBuffer(safetensor, metadata['_bn0.running_var']));
    const buf_5 = createWeightBuf(device, 128, getTensorBuffer(safetensor, metadata['_bn0.bias']));
    const buf_6 = createEmptyBuf(device, 1605632);;
    const buf_7 = createWeightBuf(device, 1152, getTensorBuffer(safetensor, metadata['_blocks.0._depthwise_conv']));
    const buf_8 = createEmptyBuf(device, 128);;
    const buf_9 = createWeightBuf(device, 128, getTensorBuffer(safetensor, metadata['_blocks.0._bn1.running_mean']));
    const buf_10 = createWeightBuf(device, 128, getTensorBuffer(safetensor, metadata['_blocks.0._bn1.weight']));
    const buf_11 = createWeightBuf(device, 128, getTensorBuffer(safetensor, metadata['_blocks.0._bn1.running_var']));
    const buf_12 = createWeightBuf(device, 128, getTensorBuffer(safetensor, metadata['_blocks.0._bn1.bias']));
    const buf_13 = createEmptyBuf(device, 32);;
    const buf_14 = createWeightBuf(device, 1024, getTensorBuffer(safetensor, metadata['_blocks.0._se_reduce']));
    const buf_15 = createWeightBuf(device, 32, getTensorBuffer(safetensor, metadata['_blocks.0._se_reduce_bias']));
    const buf_16 = createEmptyBuf(device, 128);;
    const buf_17 = createWeightBuf(device, 1024, getTensorBuffer(safetensor, metadata['_blocks.0._se_expand']));
    const buf_18 = createWeightBuf(device, 128, getTensorBuffer(safetensor, metadata['_blocks.0._se_expand_bias']));
    const buf_19 = createEmptyBuf(device, 1605632);;
    const buf_20 = createEmptyBuf(device, 802816);;
    const buf_21 = createWeightBuf(device, 2048, getTensorBuffer(safetensor, metadata['_blocks.0._project_conv']));
    const buf_22 = createWeightBuf(device, 64, getTensorBuffer(safetensor, metadata['_blocks.0._bn2.running_mean']));
    const buf_23 = createWeightBuf(device, 64, getTensorBuffer(safetensor, metadata['_blocks.0._bn2.weight']));
    const buf_24 = createWeightBuf(device, 64, getTensorBuffer(safetensor, metadata['_blocks.0._bn2.running_var']));
    const buf_25 = createWeightBuf(device, 64, getTensorBuffer(safetensor, metadata['_blocks.0._bn2.bias']));
    const buf_26 = createEmptyBuf(device, 4816896);;
    const buf_27 = createWeightBuf(device, 6144, getTensorBuffer(safetensor, metadata['_blocks.1._expand_conv']));
    const buf_28 = createWeightBuf(device, 384, getTensorBuffer(safetensor, metadata['_blocks.1._bn0.running_mean']));
    const buf_29 = createWeightBuf(device, 384, getTensorBuffer(safetensor, metadata['_blocks.1._bn0.weight']));
    const buf_30 = createWeightBuf(device, 384, getTensorBuffer(safetensor, metadata['_blocks.1._bn0.running_var']));
    const buf_31 = createWeightBuf(device, 384, getTensorBuffer(safetensor, metadata['_blocks.1._bn0.bias']));
    const buf_32 = createEmptyBuf(device, 1204224);;
    const buf_33 = createWeightBuf(device, 3456, getTensorBuffer(safetensor, metadata['_blocks.1._depthwise_conv']));
    const buf_34 = createEmptyBuf(device, 384);;
    const buf_35 = createWeightBuf(device, 384, getTensorBuffer(safetensor, metadata['_blocks.1._bn1.running_mean']));
    const buf_36 = createWeightBuf(device, 384, getTensorBuffer(safetensor, metadata['_blocks.1._bn1.weight']));
    const buf_37 = createWeightBuf(device, 384, getTensorBuffer(safetensor, metadata['_blocks.1._bn1.running_var']));
    const buf_38 = createWeightBuf(device, 384, getTensorBuffer(safetensor, metadata['_blocks.1._bn1.bias']));
    const buf_39 = createEmptyBuf(device, 16);;
    const buf_40 = createWeightBuf(device, 1536, getTensorBuffer(safetensor, metadata['_blocks.1._se_reduce']));
    const buf_41 = createWeightBuf(device, 16, getTensorBuffer(safetensor, metadata['_blocks.1._se_reduce_bias']));
    const buf_42 = createEmptyBuf(device, 384);;
    const buf_43 = createWeightBuf(device, 1536, getTensorBuffer(safetensor, metadata['_blocks.1._se_expand']));
    const buf_44 = createWeightBuf(device, 384, getTensorBuffer(safetensor, metadata['_blocks.1._se_expand_bias']));
    const buf_45 = createEmptyBuf(device, 1204224);;
    const buf_46 = createEmptyBuf(device, 301056);;
    const buf_47 = createWeightBuf(device, 9216, getTensorBuffer(safetensor, metadata['_blocks.1._project_conv']));
    const buf_48 = createWeightBuf(device, 96, getTensorBuffer(safetensor, metadata['_blocks.1._bn2.running_mean']));
    const buf_49 = createWeightBuf(device, 96, getTensorBuffer(safetensor, metadata['_blocks.1._bn2.weight']));
    const buf_50 = createWeightBuf(device, 96, getTensorBuffer(safetensor, metadata['_blocks.1._bn2.running_var']));
    const buf_51 = createWeightBuf(device, 96, getTensorBuffer(safetensor, metadata['_blocks.1._bn2.bias']));
    const buf_52 = createEmptyBuf(device, 1806336);;
    const buf_53 = createWeightBuf(device, 13824, getTensorBuffer(safetensor, metadata['_blocks.2._expand_conv']));
    const buf_54 = createWeightBuf(device, 576, getTensorBuffer(safetensor, metadata['_blocks.2._bn0.running_mean']));
    const buf_55 = createWeightBuf(device, 576, getTensorBuffer(safetensor, metadata['_blocks.2._bn0.weight']));
    const buf_56 = createWeightBuf(device, 576, getTensorBuffer(safetensor, metadata['_blocks.2._bn0.running_var']));
    const buf_57 = createWeightBuf(device, 576, getTensorBuffer(safetensor, metadata['_blocks.2._bn0.bias']));
    const buf_58 = createEmptyBuf(device, 1806336);;
    const buf_59 = createWeightBuf(device, 5184, getTensorBuffer(safetensor, metadata['_blocks.2._depthwise_conv']));
    const buf_60 = createEmptyBuf(device, 576);;
    const buf_61 = createWeightBuf(device, 576, getTensorBuffer(safetensor, metadata['_blocks.2._bn1.running_mean']));
    const buf_62 = createWeightBuf(device, 576, getTensorBuffer(safetensor, metadata['_blocks.2._bn1.weight']));
    const buf_63 = createWeightBuf(device, 576, getTensorBuffer(safetensor, metadata['_blocks.2._bn1.running_var']));
    const buf_64 = createWeightBuf(device, 576, getTensorBuffer(safetensor, metadata['_blocks.2._bn1.bias']));
    const buf_65 = createEmptyBuf(device, 24);;
    const buf_66 = createWeightBuf(device, 3456, getTensorBuffer(safetensor, metadata['_blocks.2._se_reduce']));
    const buf_67 = createWeightBuf(device, 24, getTensorBuffer(safetensor, metadata['_blocks.2._se_reduce_bias']));
    const buf_68 = createEmptyBuf(device, 576);;
    const buf_69 = createWeightBuf(device, 3456, getTensorBuffer(safetensor, metadata['_blocks.2._se_expand']));
    const buf_70 = createWeightBuf(device, 576, getTensorBuffer(safetensor, metadata['_blocks.2._se_expand_bias']));
    const buf_71 = createEmptyBuf(device, 1806336);;
    const buf_72 = createEmptyBuf(device, 301056);;
    const buf_73 = createWeightBuf(device, 13824, getTensorBuffer(safetensor, metadata['_blocks.2._project_conv']));
    const buf_74 = createWeightBuf(device, 96, getTensorBuffer(safetensor, metadata['_blocks.2._bn2.running_mean']));
    const buf_75 = createWeightBuf(device, 96, getTensorBuffer(safetensor, metadata['_blocks.2._bn2.weight']));
    const buf_76 = createWeightBuf(device, 96, getTensorBuffer(safetensor, metadata['_blocks.2._bn2.running_var']));
    const buf_77 = createWeightBuf(device, 96, getTensorBuffer(safetensor, metadata['_blocks.2._bn2.bias']));
    const buf_78 = createEmptyBuf(device, 1806336);;
    const buf_79 = createWeightBuf(device, 13824, getTensorBuffer(safetensor, metadata['_blocks.3._expand_conv']));
    const buf_80 = createWeightBuf(device, 576, getTensorBuffer(safetensor, metadata['_blocks.3._bn0.running_mean']));
    const buf_81 = createWeightBuf(device, 576, getTensorBuffer(safetensor, metadata['_blocks.3._bn0.weight']));
    const buf_82 = createWeightBuf(device, 576, getTensorBuffer(safetensor, metadata['_blocks.3._bn0.running_var']));
    const buf_83 = createWeightBuf(device, 576, getTensorBuffer(safetensor, metadata['_blocks.3._bn0.bias']));
    const buf_84 = createEmptyBuf(device, 451584);;
    const buf_85 = createWeightBuf(device, 14400, getTensorBuffer(safetensor, metadata['_blocks.3._depthwise_conv']));
    const buf_86 = createEmptyBuf(device, 576);;
    const buf_87 = createWeightBuf(device, 576, getTensorBuffer(safetensor, metadata['_blocks.3._bn1.running_mean']));
    const buf_88 = createWeightBuf(device, 576, getTensorBuffer(safetensor, metadata['_blocks.3._bn1.weight']));
    const buf_89 = createWeightBuf(device, 576, getTensorBuffer(safetensor, metadata['_blocks.3._bn1.running_var']));
    const buf_90 = createWeightBuf(device, 576, getTensorBuffer(safetensor, metadata['_blocks.3._bn1.bias']));
    const buf_91 = createEmptyBuf(device, 24);;
    const buf_92 = createWeightBuf(device, 3456, getTensorBuffer(safetensor, metadata['_blocks.3._se_reduce']));
    const buf_93 = createWeightBuf(device, 24, getTensorBuffer(safetensor, metadata['_blocks.3._se_reduce_bias']));
    const buf_94 = createEmptyBuf(device, 576);;
    const buf_95 = createWeightBuf(device, 3456, getTensorBuffer(safetensor, metadata['_blocks.3._se_expand']));
    const buf_96 = createWeightBuf(device, 576, getTensorBuffer(safetensor, metadata['_blocks.3._se_expand_bias']));
    const buf_97 = createEmptyBuf(device, 451584);;
    const buf_98 = createEmptyBuf(device, 125440);;
    const buf_99 = createWeightBuf(device, 23040, getTensorBuffer(safetensor, metadata['_blocks.3._project_conv']));
    const buf_100 = createWeightBuf(device, 160, getTensorBuffer(safetensor, metadata['_blocks.3._bn2.running_mean']));
    const buf_101 = createWeightBuf(device, 160, getTensorBuffer(safetensor, metadata['_blocks.3._bn2.weight']));
    const buf_102 = createWeightBuf(device, 160, getTensorBuffer(safetensor, metadata['_blocks.3._bn2.running_var']));
    const buf_103 = createWeightBuf(device, 160, getTensorBuffer(safetensor, metadata['_blocks.3._bn2.bias']));
    const buf_104 = createEmptyBuf(device, 752640);;
    const buf_105 = createWeightBuf(device, 38400, getTensorBuffer(safetensor, metadata['_blocks.4._expand_conv']));
    const buf_106 = createWeightBuf(device, 960, getTensorBuffer(safetensor, metadata['_blocks.4._bn0.running_mean']));
    const buf_107 = createWeightBuf(device, 960, getTensorBuffer(safetensor, metadata['_blocks.4._bn0.weight']));
    const buf_108 = createWeightBuf(device, 960, getTensorBuffer(safetensor, metadata['_blocks.4._bn0.running_var']));
    const buf_109 = createWeightBuf(device, 960, getTensorBuffer(safetensor, metadata['_blocks.4._bn0.bias']));
    const buf_110 = createEmptyBuf(device, 752640);;
    const buf_111 = createWeightBuf(device, 24000, getTensorBuffer(safetensor, metadata['_blocks.4._depthwise_conv']));
    const buf_112 = createEmptyBuf(device, 960);;
    const buf_113 = createWeightBuf(device, 960, getTensorBuffer(safetensor, metadata['_blocks.4._bn1.running_mean']));
    const buf_114 = createWeightBuf(device, 960, getTensorBuffer(safetensor, metadata['_blocks.4._bn1.weight']));
    const buf_115 = createWeightBuf(device, 960, getTensorBuffer(safetensor, metadata['_blocks.4._bn1.running_var']));
    const buf_116 = createWeightBuf(device, 960, getTensorBuffer(safetensor, metadata['_blocks.4._bn1.bias']));
    const buf_117 = createEmptyBuf(device, 40);;
    const buf_118 = createWeightBuf(device, 9600, getTensorBuffer(safetensor, metadata['_blocks.4._se_reduce']));
    const buf_119 = createWeightBuf(device, 40, getTensorBuffer(safetensor, metadata['_blocks.4._se_reduce_bias']));
    const buf_120 = createEmptyBuf(device, 960);;
    const buf_121 = createWeightBuf(device, 9600, getTensorBuffer(safetensor, metadata['_blocks.4._se_expand']));
    const buf_122 = createWeightBuf(device, 960, getTensorBuffer(safetensor, metadata['_blocks.4._se_expand_bias']));
    const buf_123 = createEmptyBuf(device, 752640);;
    const buf_124 = createEmptyBuf(device, 125440);;
    const buf_125 = createWeightBuf(device, 38400, getTensorBuffer(safetensor, metadata['_blocks.4._project_conv']));
    const buf_126 = createWeightBuf(device, 160, getTensorBuffer(safetensor, metadata['_blocks.4._bn2.running_mean']));
    const buf_127 = createWeightBuf(device, 160, getTensorBuffer(safetensor, metadata['_blocks.4._bn2.weight']));
    const buf_128 = createWeightBuf(device, 160, getTensorBuffer(safetensor, metadata['_blocks.4._bn2.running_var']));
    const buf_129 = createWeightBuf(device, 160, getTensorBuffer(safetensor, metadata['_blocks.4._bn2.bias']));
    const buf_130 = createEmptyBuf(device, 752640);;
    const buf_131 = createWeightBuf(device, 38400, getTensorBuffer(safetensor, metadata['_blocks.5._expand_conv']));
    const buf_132 = createWeightBuf(device, 960, getTensorBuffer(safetensor, metadata['_blocks.5._bn0.running_mean']));
    const buf_133 = createWeightBuf(device, 960, getTensorBuffer(safetensor, metadata['_blocks.5._bn0.weight']));
    const buf_134 = createWeightBuf(device, 960, getTensorBuffer(safetensor, metadata['_blocks.5._bn0.running_var']));
    const buf_135 = createWeightBuf(device, 960, getTensorBuffer(safetensor, metadata['_blocks.5._bn0.bias']));
    const buf_136 = createEmptyBuf(device, 188160);;
    const buf_137 = createWeightBuf(device, 8640, getTensorBuffer(safetensor, metadata['_blocks.5._depthwise_conv']));
    const buf_138 = createEmptyBuf(device, 960);;
    const buf_139 = createWeightBuf(device, 960, getTensorBuffer(safetensor, metadata['_blocks.5._bn1.running_mean']));
    const buf_140 = createWeightBuf(device, 960, getTensorBuffer(safetensor, metadata['_blocks.5._bn1.weight']));
    const buf_141 = createWeightBuf(device, 960, getTensorBuffer(safetensor, metadata['_blocks.5._bn1.running_var']));
    const buf_142 = createWeightBuf(device, 960, getTensorBuffer(safetensor, metadata['_blocks.5._bn1.bias']));
    const buf_143 = createEmptyBuf(device, 40);;
    const buf_144 = createWeightBuf(device, 9600, getTensorBuffer(safetensor, metadata['_blocks.5._se_reduce']));
    const buf_145 = createWeightBuf(device, 40, getTensorBuffer(safetensor, metadata['_blocks.5._se_reduce_bias']));
    const buf_146 = createEmptyBuf(device, 960);;
    const buf_147 = createWeightBuf(device, 9600, getTensorBuffer(safetensor, metadata['_blocks.5._se_expand']));
    const buf_148 = createWeightBuf(device, 960, getTensorBuffer(safetensor, metadata['_blocks.5._se_expand_bias']));
    const buf_149 = createEmptyBuf(device, 188160);;
    const buf_150 = createEmptyBuf(device, 62720);;
    const buf_151 = createWeightBuf(device, 76800, getTensorBuffer(safetensor, metadata['_blocks.5._project_conv']));
    const buf_152 = createWeightBuf(device, 320, getTensorBuffer(safetensor, metadata['_blocks.5._bn2.running_mean']));
    const buf_153 = createWeightBuf(device, 320, getTensorBuffer(safetensor, metadata['_blocks.5._bn2.weight']));
    const buf_154 = createWeightBuf(device, 320, getTensorBuffer(safetensor, metadata['_blocks.5._bn2.running_var']));
    const buf_155 = createWeightBuf(device, 320, getTensorBuffer(safetensor, metadata['_blocks.5._bn2.bias']));
    const buf_156 = createEmptyBuf(device, 376320);;
    const buf_157 = createWeightBuf(device, 153600, getTensorBuffer(safetensor, metadata['_blocks.6._expand_conv']));
    const buf_158 = createWeightBuf(device, 1920, getTensorBuffer(safetensor, metadata['_blocks.6._bn0.running_mean']));
    const buf_159 = createWeightBuf(device, 1920, getTensorBuffer(safetensor, metadata['_blocks.6._bn0.weight']));
    const buf_160 = createWeightBuf(device, 1920, getTensorBuffer(safetensor, metadata['_blocks.6._bn0.running_var']));
    const buf_161 = createWeightBuf(device, 1920, getTensorBuffer(safetensor, metadata['_blocks.6._bn0.bias']));
    const buf_162 = createEmptyBuf(device, 376320);;
    const buf_163 = createWeightBuf(device, 17280, getTensorBuffer(safetensor, metadata['_blocks.6._depthwise_conv']));
    const buf_164 = createEmptyBuf(device, 1920);;
    const buf_165 = createWeightBuf(device, 1920, getTensorBuffer(safetensor, metadata['_blocks.6._bn1.running_mean']));
    const buf_166 = createWeightBuf(device, 1920, getTensorBuffer(safetensor, metadata['_blocks.6._bn1.weight']));
    const buf_167 = createWeightBuf(device, 1920, getTensorBuffer(safetensor, metadata['_blocks.6._bn1.running_var']));
    const buf_168 = createWeightBuf(device, 1920, getTensorBuffer(safetensor, metadata['_blocks.6._bn1.bias']));
    const buf_169 = createEmptyBuf(device, 80);;
    const buf_170 = createWeightBuf(device, 38400, getTensorBuffer(safetensor, metadata['_blocks.6._se_reduce']));
    const buf_171 = createWeightBuf(device, 80, getTensorBuffer(safetensor, metadata['_blocks.6._se_reduce_bias']));
    const buf_172 = createEmptyBuf(device, 1920);;
    const buf_173 = createWeightBuf(device, 38400, getTensorBuffer(safetensor, metadata['_blocks.6._se_expand']));
    const buf_174 = createWeightBuf(device, 1920, getTensorBuffer(safetensor, metadata['_blocks.6._se_expand_bias']));
    const buf_175 = createEmptyBuf(device, 376320);;
    const buf_176 = createEmptyBuf(device, 62720);;
    const buf_177 = createWeightBuf(device, 153600, getTensorBuffer(safetensor, metadata['_blocks.6._project_conv']));
    const buf_178 = createWeightBuf(device, 320, getTensorBuffer(safetensor, metadata['_blocks.6._bn2.running_mean']));
    const buf_179 = createWeightBuf(device, 320, getTensorBuffer(safetensor, metadata['_blocks.6._bn2.weight']));
    const buf_180 = createWeightBuf(device, 320, getTensorBuffer(safetensor, metadata['_blocks.6._bn2.running_var']));
    const buf_181 = createWeightBuf(device, 320, getTensorBuffer(safetensor, metadata['_blocks.6._bn2.bias']));
    const buf_182 = createEmptyBuf(device, 376320);;
    const buf_183 = createWeightBuf(device, 153600, getTensorBuffer(safetensor, metadata['_blocks.7._expand_conv']));
    const buf_184 = createWeightBuf(device, 1920, getTensorBuffer(safetensor, metadata['_blocks.7._bn0.running_mean']));
    const buf_185 = createWeightBuf(device, 1920, getTensorBuffer(safetensor, metadata['_blocks.7._bn0.weight']));
    const buf_186 = createWeightBuf(device, 1920, getTensorBuffer(safetensor, metadata['_blocks.7._bn0.running_var']));
    const buf_187 = createWeightBuf(device, 1920, getTensorBuffer(safetensor, metadata['_blocks.7._bn0.bias']));
    const buf_188 = createEmptyBuf(device, 376320);;
    const buf_189 = createWeightBuf(device, 17280, getTensorBuffer(safetensor, metadata['_blocks.7._depthwise_conv']));
    const buf_190 = createEmptyBuf(device, 1920);;
    const buf_191 = createWeightBuf(device, 1920, getTensorBuffer(safetensor, metadata['_blocks.7._bn1.running_mean']));
    const buf_192 = createWeightBuf(device, 1920, getTensorBuffer(safetensor, metadata['_blocks.7._bn1.weight']));
    const buf_193 = createWeightBuf(device, 1920, getTensorBuffer(safetensor, metadata['_blocks.7._bn1.running_var']));
    const buf_194 = createWeightBuf(device, 1920, getTensorBuffer(safetensor, metadata['_blocks.7._bn1.bias']));
    const buf_195 = createEmptyBuf(device, 80);;
    const buf_196 = createWeightBuf(device, 38400, getTensorBuffer(safetensor, metadata['_blocks.7._se_reduce']));
    const buf_197 = createWeightBuf(device, 80, getTensorBuffer(safetensor, metadata['_blocks.7._se_reduce_bias']));
    const buf_198 = createEmptyBuf(device, 1920);;
    const buf_199 = createWeightBuf(device, 38400, getTensorBuffer(safetensor, metadata['_blocks.7._se_expand']));
    const buf_200 = createWeightBuf(device, 1920, getTensorBuffer(safetensor, metadata['_blocks.7._se_expand_bias']));
    const buf_201 = createEmptyBuf(device, 376320);;
    const buf_202 = createEmptyBuf(device, 62720);;
    const buf_203 = createWeightBuf(device, 153600, getTensorBuffer(safetensor, metadata['_blocks.7._project_conv']));
    const buf_204 = createWeightBuf(device, 320, getTensorBuffer(safetensor, metadata['_blocks.7._bn2.running_mean']));
    const buf_205 = createWeightBuf(device, 320, getTensorBuffer(safetensor, metadata['_blocks.7._bn2.weight']));
    const buf_206 = createWeightBuf(device, 320, getTensorBuffer(safetensor, metadata['_blocks.7._bn2.running_var']));
    const buf_207 = createWeightBuf(device, 320, getTensorBuffer(safetensor, metadata['_blocks.7._bn2.bias']));
    const buf_208 = createEmptyBuf(device, 376320);;
    const buf_209 = createWeightBuf(device, 153600, getTensorBuffer(safetensor, metadata['_blocks.8._expand_conv']));
    const buf_210 = createWeightBuf(device, 1920, getTensorBuffer(safetensor, metadata['_blocks.8._bn0.running_mean']));
    const buf_211 = createWeightBuf(device, 1920, getTensorBuffer(safetensor, metadata['_blocks.8._bn0.weight']));
    const buf_212 = createWeightBuf(device, 1920, getTensorBuffer(safetensor, metadata['_blocks.8._bn0.running_var']));
    const buf_213 = createWeightBuf(device, 1920, getTensorBuffer(safetensor, metadata['_blocks.8._bn0.bias']));
    const buf_214 = createEmptyBuf(device, 376320);;
    const buf_215 = createWeightBuf(device, 48000, getTensorBuffer(safetensor, metadata['_blocks.8._depthwise_conv']));
    const buf_216 = createEmptyBuf(device, 1920);;
    const buf_217 = createWeightBuf(device, 1920, getTensorBuffer(safetensor, metadata['_blocks.8._bn1.running_mean']));
    const buf_218 = createWeightBuf(device, 1920, getTensorBuffer(safetensor, metadata['_blocks.8._bn1.weight']));
    const buf_219 = createWeightBuf(device, 1920, getTensorBuffer(safetensor, metadata['_blocks.8._bn1.running_var']));
    const buf_220 = createWeightBuf(device, 1920, getTensorBuffer(safetensor, metadata['_blocks.8._bn1.bias']));
    const buf_221 = createEmptyBuf(device, 80);;
    const buf_222 = createWeightBuf(device, 38400, getTensorBuffer(safetensor, metadata['_blocks.8._se_reduce']));
    const buf_223 = createWeightBuf(device, 80, getTensorBuffer(safetensor, metadata['_blocks.8._se_reduce_bias']));
    const buf_224 = createEmptyBuf(device, 1920);;
    const buf_225 = createWeightBuf(device, 38400, getTensorBuffer(safetensor, metadata['_blocks.8._se_expand']));
    const buf_226 = createWeightBuf(device, 1920, getTensorBuffer(safetensor, metadata['_blocks.8._se_expand_bias']));
    const buf_227 = createEmptyBuf(device, 376320);;
    const buf_228 = createEmptyBuf(device, 87808);;
    const buf_229 = createWeightBuf(device, 215040, getTensorBuffer(safetensor, metadata['_blocks.8._project_conv']));
    const buf_230 = createWeightBuf(device, 448, getTensorBuffer(safetensor, metadata['_blocks.8._bn2.running_mean']));
    const buf_231 = createWeightBuf(device, 448, getTensorBuffer(safetensor, metadata['_blocks.8._bn2.weight']));
    const buf_232 = createWeightBuf(device, 448, getTensorBuffer(safetensor, metadata['_blocks.8._bn2.running_var']));
    const buf_233 = createWeightBuf(device, 448, getTensorBuffer(safetensor, metadata['_blocks.8._bn2.bias']));
    const buf_234 = createEmptyBuf(device, 526848);;
    const buf_235 = createWeightBuf(device, 301056, getTensorBuffer(safetensor, metadata['_blocks.9._expand_conv']));
    const buf_236 = createWeightBuf(device, 2688, getTensorBuffer(safetensor, metadata['_blocks.9._bn0.running_mean']));
    const buf_237 = createWeightBuf(device, 2688, getTensorBuffer(safetensor, metadata['_blocks.9._bn0.weight']));
    const buf_238 = createWeightBuf(device, 2688, getTensorBuffer(safetensor, metadata['_blocks.9._bn0.running_var']));
    const buf_239 = createWeightBuf(device, 2688, getTensorBuffer(safetensor, metadata['_blocks.9._bn0.bias']));
    const buf_240 = createEmptyBuf(device, 526848);;
    const buf_241 = createWeightBuf(device, 67200, getTensorBuffer(safetensor, metadata['_blocks.9._depthwise_conv']));
    const buf_242 = createEmptyBuf(device, 2688);;
    const buf_243 = createWeightBuf(device, 2688, getTensorBuffer(safetensor, metadata['_blocks.9._bn1.running_mean']));
    const buf_244 = createWeightBuf(device, 2688, getTensorBuffer(safetensor, metadata['_blocks.9._bn1.weight']));
    const buf_245 = createWeightBuf(device, 2688, getTensorBuffer(safetensor, metadata['_blocks.9._bn1.running_var']));
    const buf_246 = createWeightBuf(device, 2688, getTensorBuffer(safetensor, metadata['_blocks.9._bn1.bias']));
    const buf_247 = createEmptyBuf(device, 112);;
    const buf_248 = createWeightBuf(device, 75264, getTensorBuffer(safetensor, metadata['_blocks.9._se_reduce']));
    const buf_249 = createWeightBuf(device, 112, getTensorBuffer(safetensor, metadata['_blocks.9._se_reduce_bias']));
    const buf_250 = createEmptyBuf(device, 2688);;
    const buf_251 = createWeightBuf(device, 75264, getTensorBuffer(safetensor, metadata['_blocks.9._se_expand']));
    const buf_252 = createWeightBuf(device, 2688, getTensorBuffer(safetensor, metadata['_blocks.9._se_expand_bias']));
    const buf_253 = createEmptyBuf(device, 526848);;
    const buf_254 = createEmptyBuf(device, 87808);;
    const buf_255 = createWeightBuf(device, 301056, getTensorBuffer(safetensor, metadata['_blocks.9._project_conv']));
    const buf_256 = createWeightBuf(device, 448, getTensorBuffer(safetensor, metadata['_blocks.9._bn2.running_mean']));
    const buf_257 = createWeightBuf(device, 448, getTensorBuffer(safetensor, metadata['_blocks.9._bn2.weight']));
    const buf_258 = createWeightBuf(device, 448, getTensorBuffer(safetensor, metadata['_blocks.9._bn2.running_var']));
    const buf_259 = createWeightBuf(device, 448, getTensorBuffer(safetensor, metadata['_blocks.9._bn2.bias']));
    const buf_260 = createEmptyBuf(device, 526848);;
    const buf_261 = createWeightBuf(device, 301056, getTensorBuffer(safetensor, metadata['_blocks.10._expand_conv']));
    const buf_262 = createWeightBuf(device, 2688, getTensorBuffer(safetensor, metadata['_blocks.10._bn0.running_mean']));
    const buf_263 = createWeightBuf(device, 2688, getTensorBuffer(safetensor, metadata['_blocks.10._bn0.weight']));
    const buf_264 = createWeightBuf(device, 2688, getTensorBuffer(safetensor, metadata['_blocks.10._bn0.running_var']));
    const buf_265 = createWeightBuf(device, 2688, getTensorBuffer(safetensor, metadata['_blocks.10._bn0.bias']));
    const buf_266 = createEmptyBuf(device, 526848);;
    const buf_267 = createWeightBuf(device, 67200, getTensorBuffer(safetensor, metadata['_blocks.10._depthwise_conv']));
    const buf_268 = createEmptyBuf(device, 2688);;
    const buf_269 = createWeightBuf(device, 2688, getTensorBuffer(safetensor, metadata['_blocks.10._bn1.running_mean']));
    const buf_270 = createWeightBuf(device, 2688, getTensorBuffer(safetensor, metadata['_blocks.10._bn1.weight']));
    const buf_271 = createWeightBuf(device, 2688, getTensorBuffer(safetensor, metadata['_blocks.10._bn1.running_var']));
    const buf_272 = createWeightBuf(device, 2688, getTensorBuffer(safetensor, metadata['_blocks.10._bn1.bias']));
    const buf_273 = createEmptyBuf(device, 112);;
    const buf_274 = createWeightBuf(device, 75264, getTensorBuffer(safetensor, metadata['_blocks.10._se_reduce']));
    const buf_275 = createWeightBuf(device, 112, getTensorBuffer(safetensor, metadata['_blocks.10._se_reduce_bias']));
    const buf_276 = createEmptyBuf(device, 2688);;
    const buf_277 = createWeightBuf(device, 75264, getTensorBuffer(safetensor, metadata['_blocks.10._se_expand']));
    const buf_278 = createWeightBuf(device, 2688, getTensorBuffer(safetensor, metadata['_blocks.10._se_expand_bias']));
    const buf_279 = createEmptyBuf(device, 526848);;
    const buf_280 = createEmptyBuf(device, 87808);;
    const buf_281 = createWeightBuf(device, 301056, getTensorBuffer(safetensor, metadata['_blocks.10._project_conv']));
    const buf_282 = createWeightBuf(device, 448, getTensorBuffer(safetensor, metadata['_blocks.10._bn2.running_mean']));
    const buf_283 = createWeightBuf(device, 448, getTensorBuffer(safetensor, metadata['_blocks.10._bn2.weight']));
    const buf_284 = createWeightBuf(device, 448, getTensorBuffer(safetensor, metadata['_blocks.10._bn2.running_var']));
    const buf_285 = createWeightBuf(device, 448, getTensorBuffer(safetensor, metadata['_blocks.10._bn2.bias']));
    const buf_286 = createEmptyBuf(device, 526848);;
    const buf_287 = createWeightBuf(device, 301056, getTensorBuffer(safetensor, metadata['_blocks.11._expand_conv']));
    const buf_288 = createWeightBuf(device, 2688, getTensorBuffer(safetensor, metadata['_blocks.11._bn0.running_mean']));
    const buf_289 = createWeightBuf(device, 2688, getTensorBuffer(safetensor, metadata['_blocks.11._bn0.weight']));
    const buf_290 = createWeightBuf(device, 2688, getTensorBuffer(safetensor, metadata['_blocks.11._bn0.running_var']));
    const buf_291 = createWeightBuf(device, 2688, getTensorBuffer(safetensor, metadata['_blocks.11._bn0.bias']));
    const buf_292 = createEmptyBuf(device, 131712);;
    const buf_293 = createWeightBuf(device, 67200, getTensorBuffer(safetensor, metadata['_blocks.11._depthwise_conv']));
    const buf_294 = createEmptyBuf(device, 2688);;
    const buf_295 = createWeightBuf(device, 2688, getTensorBuffer(safetensor, metadata['_blocks.11._bn1.running_mean']));
    const buf_296 = createWeightBuf(device, 2688, getTensorBuffer(safetensor, metadata['_blocks.11._bn1.weight']));
    const buf_297 = createWeightBuf(device, 2688, getTensorBuffer(safetensor, metadata['_blocks.11._bn1.running_var']));
    const buf_298 = createWeightBuf(device, 2688, getTensorBuffer(safetensor, metadata['_blocks.11._bn1.bias']));
    const buf_299 = createEmptyBuf(device, 112);;
    const buf_300 = createWeightBuf(device, 75264, getTensorBuffer(safetensor, metadata['_blocks.11._se_reduce']));
    const buf_301 = createWeightBuf(device, 112, getTensorBuffer(safetensor, metadata['_blocks.11._se_reduce_bias']));
    const buf_302 = createEmptyBuf(device, 2688);;
    const buf_303 = createWeightBuf(device, 75264, getTensorBuffer(safetensor, metadata['_blocks.11._se_expand']));
    const buf_304 = createWeightBuf(device, 2688, getTensorBuffer(safetensor, metadata['_blocks.11._se_expand_bias']));
    const buf_305 = createEmptyBuf(device, 131712);;
    const buf_306 = createEmptyBuf(device, 37632);;
    const buf_307 = createWeightBuf(device, 516096, getTensorBuffer(safetensor, metadata['_blocks.11._project_conv']));
    const buf_308 = createWeightBuf(device, 768, getTensorBuffer(safetensor, metadata['_blocks.11._bn2.running_mean']));
    const buf_309 = createWeightBuf(device, 768, getTensorBuffer(safetensor, metadata['_blocks.11._bn2.weight']));
    const buf_310 = createWeightBuf(device, 768, getTensorBuffer(safetensor, metadata['_blocks.11._bn2.running_var']));
    const buf_311 = createWeightBuf(device, 768, getTensorBuffer(safetensor, metadata['_blocks.11._bn2.bias']));
    const buf_312 = createEmptyBuf(device, 225792);;
    const buf_313 = createWeightBuf(device, 884736, getTensorBuffer(safetensor, metadata['_blocks.12._expand_conv']));
    const buf_314 = createWeightBuf(device, 4608, getTensorBuffer(safetensor, metadata['_blocks.12._bn0.running_mean']));
    const buf_315 = createWeightBuf(device, 4608, getTensorBuffer(safetensor, metadata['_blocks.12._bn0.weight']));
    const buf_316 = createWeightBuf(device, 4608, getTensorBuffer(safetensor, metadata['_blocks.12._bn0.running_var']));
    const buf_317 = createWeightBuf(device, 4608, getTensorBuffer(safetensor, metadata['_blocks.12._bn0.bias']));
    const buf_318 = createEmptyBuf(device, 225792);;
    const buf_319 = createWeightBuf(device, 115200, getTensorBuffer(safetensor, metadata['_blocks.12._depthwise_conv']));
    const buf_320 = createEmptyBuf(device, 4608);;
    const buf_321 = createWeightBuf(device, 4608, getTensorBuffer(safetensor, metadata['_blocks.12._bn1.running_mean']));
    const buf_322 = createWeightBuf(device, 4608, getTensorBuffer(safetensor, metadata['_blocks.12._bn1.weight']));
    const buf_323 = createWeightBuf(device, 4608, getTensorBuffer(safetensor, metadata['_blocks.12._bn1.running_var']));
    const buf_324 = createWeightBuf(device, 4608, getTensorBuffer(safetensor, metadata['_blocks.12._bn1.bias']));
    const buf_325 = createEmptyBuf(device, 192);;
    const buf_326 = createWeightBuf(device, 221184, getTensorBuffer(safetensor, metadata['_blocks.12._se_reduce']));
    const buf_327 = createWeightBuf(device, 192, getTensorBuffer(safetensor, metadata['_blocks.12._se_reduce_bias']));
    const buf_328 = createEmptyBuf(device, 4608);;
    const buf_329 = createWeightBuf(device, 221184, getTensorBuffer(safetensor, metadata['_blocks.12._se_expand']));
    const buf_330 = createWeightBuf(device, 4608, getTensorBuffer(safetensor, metadata['_blocks.12._se_expand_bias']));
    const buf_331 = createEmptyBuf(device, 225792);;
    const buf_332 = createEmptyBuf(device, 37632);;
    const buf_333 = createWeightBuf(device, 884736, getTensorBuffer(safetensor, metadata['_blocks.12._project_conv']));
    const buf_334 = createWeightBuf(device, 768, getTensorBuffer(safetensor, metadata['_blocks.12._bn2.running_mean']));
    const buf_335 = createWeightBuf(device, 768, getTensorBuffer(safetensor, metadata['_blocks.12._bn2.weight']));
    const buf_336 = createWeightBuf(device, 768, getTensorBuffer(safetensor, metadata['_blocks.12._bn2.running_var']));
    const buf_337 = createWeightBuf(device, 768, getTensorBuffer(safetensor, metadata['_blocks.12._bn2.bias']));
    const buf_338 = createEmptyBuf(device, 225792);;
    const buf_339 = createWeightBuf(device, 884736, getTensorBuffer(safetensor, metadata['_blocks.13._expand_conv']));
    const buf_340 = createWeightBuf(device, 4608, getTensorBuffer(safetensor, metadata['_blocks.13._bn0.running_mean']));
    const buf_341 = createWeightBuf(device, 4608, getTensorBuffer(safetensor, metadata['_blocks.13._bn0.weight']));
    const buf_342 = createWeightBuf(device, 4608, getTensorBuffer(safetensor, metadata['_blocks.13._bn0.running_var']));
    const buf_343 = createWeightBuf(device, 4608, getTensorBuffer(safetensor, metadata['_blocks.13._bn0.bias']));
    const buf_344 = createEmptyBuf(device, 225792);;
    const buf_345 = createWeightBuf(device, 115200, getTensorBuffer(safetensor, metadata['_blocks.13._depthwise_conv']));
    const buf_346 = createEmptyBuf(device, 4608);;
    const buf_347 = createWeightBuf(device, 4608, getTensorBuffer(safetensor, metadata['_blocks.13._bn1.running_mean']));
    const buf_348 = createWeightBuf(device, 4608, getTensorBuffer(safetensor, metadata['_blocks.13._bn1.weight']));
    const buf_349 = createWeightBuf(device, 4608, getTensorBuffer(safetensor, metadata['_blocks.13._bn1.running_var']));
    const buf_350 = createWeightBuf(device, 4608, getTensorBuffer(safetensor, metadata['_blocks.13._bn1.bias']));
    const buf_351 = createEmptyBuf(device, 192);;
    const buf_352 = createWeightBuf(device, 221184, getTensorBuffer(safetensor, metadata['_blocks.13._se_reduce']));
    const buf_353 = createWeightBuf(device, 192, getTensorBuffer(safetensor, metadata['_blocks.13._se_reduce_bias']));
    const buf_354 = createEmptyBuf(device, 4608);;
    const buf_355 = createWeightBuf(device, 221184, getTensorBuffer(safetensor, metadata['_blocks.13._se_expand']));
    const buf_356 = createWeightBuf(device, 4608, getTensorBuffer(safetensor, metadata['_blocks.13._se_expand_bias']));
    const buf_357 = createEmptyBuf(device, 225792);;
    const buf_358 = createEmptyBuf(device, 37632);;
    const buf_359 = createWeightBuf(device, 884736, getTensorBuffer(safetensor, metadata['_blocks.13._project_conv']));
    const buf_360 = createWeightBuf(device, 768, getTensorBuffer(safetensor, metadata['_blocks.13._bn2.running_mean']));
    const buf_361 = createWeightBuf(device, 768, getTensorBuffer(safetensor, metadata['_blocks.13._bn2.weight']));
    const buf_362 = createWeightBuf(device, 768, getTensorBuffer(safetensor, metadata['_blocks.13._bn2.running_var']));
    const buf_363 = createWeightBuf(device, 768, getTensorBuffer(safetensor, metadata['_blocks.13._bn2.bias']));
    const buf_364 = createEmptyBuf(device, 225792);;
    const buf_365 = createWeightBuf(device, 884736, getTensorBuffer(safetensor, metadata['_blocks.14._expand_conv']));
    const buf_366 = createWeightBuf(device, 4608, getTensorBuffer(safetensor, metadata['_blocks.14._bn0.running_mean']));
    const buf_367 = createWeightBuf(device, 4608, getTensorBuffer(safetensor, metadata['_blocks.14._bn0.weight']));
    const buf_368 = createWeightBuf(device, 4608, getTensorBuffer(safetensor, metadata['_blocks.14._bn0.running_var']));
    const buf_369 = createWeightBuf(device, 4608, getTensorBuffer(safetensor, metadata['_blocks.14._bn0.bias']));
    const buf_370 = createEmptyBuf(device, 225792);;
    const buf_371 = createWeightBuf(device, 115200, getTensorBuffer(safetensor, metadata['_blocks.14._depthwise_conv']));
    const buf_372 = createEmptyBuf(device, 4608);;
    const buf_373 = createWeightBuf(device, 4608, getTensorBuffer(safetensor, metadata['_blocks.14._bn1.running_mean']));
    const buf_374 = createWeightBuf(device, 4608, getTensorBuffer(safetensor, metadata['_blocks.14._bn1.weight']));
    const buf_375 = createWeightBuf(device, 4608, getTensorBuffer(safetensor, metadata['_blocks.14._bn1.running_var']));
    const buf_376 = createWeightBuf(device, 4608, getTensorBuffer(safetensor, metadata['_blocks.14._bn1.bias']));
    const buf_377 = createEmptyBuf(device, 192);;
    const buf_378 = createWeightBuf(device, 221184, getTensorBuffer(safetensor, metadata['_blocks.14._se_reduce']));
    const buf_379 = createWeightBuf(device, 192, getTensorBuffer(safetensor, metadata['_blocks.14._se_reduce_bias']));
    const buf_380 = createEmptyBuf(device, 4608);;
    const buf_381 = createWeightBuf(device, 221184, getTensorBuffer(safetensor, metadata['_blocks.14._se_expand']));
    const buf_382 = createWeightBuf(device, 4608, getTensorBuffer(safetensor, metadata['_blocks.14._se_expand_bias']));
    const buf_383 = createEmptyBuf(device, 225792);;
    const buf_384 = createEmptyBuf(device, 37632);;
    const buf_385 = createWeightBuf(device, 884736, getTensorBuffer(safetensor, metadata['_blocks.14._project_conv']));
    const buf_386 = createWeightBuf(device, 768, getTensorBuffer(safetensor, metadata['_blocks.14._bn2.running_mean']));
    const buf_387 = createWeightBuf(device, 768, getTensorBuffer(safetensor, metadata['_blocks.14._bn2.weight']));
    const buf_388 = createWeightBuf(device, 768, getTensorBuffer(safetensor, metadata['_blocks.14._bn2.running_var']));
    const buf_389 = createWeightBuf(device, 768, getTensorBuffer(safetensor, metadata['_blocks.14._bn2.bias']));
    const buf_390 = createEmptyBuf(device, 225792);;
    const buf_391 = createWeightBuf(device, 884736, getTensorBuffer(safetensor, metadata['_blocks.15._expand_conv']));
    const buf_392 = createWeightBuf(device, 4608, getTensorBuffer(safetensor, metadata['_blocks.15._bn0.running_mean']));
    const buf_393 = createWeightBuf(device, 4608, getTensorBuffer(safetensor, metadata['_blocks.15._bn0.weight']));
    const buf_394 = createWeightBuf(device, 4608, getTensorBuffer(safetensor, metadata['_blocks.15._bn0.running_var']));
    const buf_395 = createWeightBuf(device, 4608, getTensorBuffer(safetensor, metadata['_blocks.15._bn0.bias']));
    const buf_396 = createEmptyBuf(device, 225792);;
    const buf_397 = createWeightBuf(device, 41472, getTensorBuffer(safetensor, metadata['_blocks.15._depthwise_conv']));
    const buf_398 = createEmptyBuf(device, 4608);;
    const buf_399 = createWeightBuf(device, 4608, getTensorBuffer(safetensor, metadata['_blocks.15._bn1.running_mean']));
    const buf_400 = createWeightBuf(device, 4608, getTensorBuffer(safetensor, metadata['_blocks.15._bn1.weight']));
    const buf_401 = createWeightBuf(device, 4608, getTensorBuffer(safetensor, metadata['_blocks.15._bn1.running_var']));
    const buf_402 = createWeightBuf(device, 4608, getTensorBuffer(safetensor, metadata['_blocks.15._bn1.bias']));
    const buf_403 = createEmptyBuf(device, 192);;
    const buf_404 = createWeightBuf(device, 221184, getTensorBuffer(safetensor, metadata['_blocks.15._se_reduce']));
    const buf_405 = createWeightBuf(device, 192, getTensorBuffer(safetensor, metadata['_blocks.15._se_reduce_bias']));
    const buf_406 = createEmptyBuf(device, 4608);;
    const buf_407 = createWeightBuf(device, 221184, getTensorBuffer(safetensor, metadata['_blocks.15._se_expand']));
    const buf_408 = createWeightBuf(device, 4608, getTensorBuffer(safetensor, metadata['_blocks.15._se_expand_bias']));
    const buf_409 = createEmptyBuf(device, 225792);;
    const buf_410 = createEmptyBuf(device, 62720);;
    const buf_411 = createWeightBuf(device, 1474560, getTensorBuffer(safetensor, metadata['_blocks.15._project_conv']));
    const buf_412 = createWeightBuf(device, 1280, getTensorBuffer(safetensor, metadata['_blocks.15._bn2.running_mean']));
    const buf_413 = createWeightBuf(device, 1280, getTensorBuffer(safetensor, metadata['_blocks.15._bn2.weight']));
    const buf_414 = createWeightBuf(device, 1280, getTensorBuffer(safetensor, metadata['_blocks.15._bn2.running_var']));
    const buf_415 = createWeightBuf(device, 1280, getTensorBuffer(safetensor, metadata['_blocks.15._bn2.bias']));
    const buf_416 = createEmptyBuf(device, 250880);;
    const buf_417 = createWeightBuf(device, 1638400, getTensorBuffer(safetensor, metadata['_conv_head']));
    const buf_418 = createEmptyBuf(device, 5120);;
    const buf_419 = createWeightBuf(device, 5120, getTensorBuffer(safetensor, metadata['_bn1.running_mean']));
    const buf_420 = createWeightBuf(device, 5120, getTensorBuffer(safetensor, metadata['_bn1.weight']));
    const buf_421 = createWeightBuf(device, 5120, getTensorBuffer(safetensor, metadata['_bn1.running_var']));
    const buf_422 = createWeightBuf(device, 5120, getTensorBuffer(safetensor, metadata['_bn1.bias']));
    const outputs = createEmptyBuf(device, 4000);;
    const buf_423 = createWeightBuf(device, 5120000, getTensorBuffer(safetensor, metadata['_fc']));
    const buf_424 = createWeightBuf(device, 4000, getTensorBuffer(safetensor, metadata['_fc_bias']));
